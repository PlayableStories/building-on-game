...
**[How a game goes →](GAME-FLOW.md)** — the round, the placement rules, how the house
decides what to say, and what the report is doing, with a screenshot at each step. Start
there if you want to know how it plays.
